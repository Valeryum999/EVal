...
constexpr U64 FILES[8] = {0x0101010101010101,
                0x0202020202020202,
                0x0404040404040404,
                0x0808080808080808,
                0x1010101010101010,
                ...
                0x4040404040404040,
                0x8080808080808080};
constexpr U64 RANKS[8] = {0x00000000000000FF,
                0x000000000000FF00,
                0x0000000000FF0000,
                0x00000000FF000000,
                0x000000FF00000000,
...
constexpr U64 notFirstRank    = 0xffffffffffffff00;
constexpr U64 notEighthRank  = 0x00ffffffffffffff;
constexpr U64 notFirstRankAFile   = 0xfefefefefefefe00; // L
constexpr U64 notFirstRankHFile   = 0x7f7f7f7f7f7f7f00;
constexpr U64 notEighthRankAFile = 0x00fefefefefefefe;
constexpr U64 notEighthRankHFile = 0x007f7f7f7f7f7f7f;
constexpr U64 notABFiles = 0xfcfcfcfcfcfcfcfc;
constexpr U64 notGHFiles = 0x3f3f3f3f3f3f3f3f;
constexpr U64 h1f1 = 0xa0;
constexpr U64 a1d1 = 0x9;
constexpr U64 h8f8 = 0xa000000000000000;
constexpr U64 a8d8 = 0x900000000000000;
constexpr U64 DIAGONAL    = 0x8040201008040201;
constexpr U64 ANTIDIAGONAL= 0x0102040810204080;
...
constexpr U64 PolyglotRandomNumbers[781] = {
